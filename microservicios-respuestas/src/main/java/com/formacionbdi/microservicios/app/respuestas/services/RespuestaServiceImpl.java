...
public class RespuestaServiceImpl implements RespuestaService {
	...
	public Iterable<Respuesta> findRespuestaByAlumnosByExamen(Long alumnoId, Long examenId) {
		...
		List<Respuesta> respuestas = (List<Respuesta>) repository.findRespuestaByAlumnosByPreguntaIds(alumnoId, preguntaIds);
		...
		List<Respuesta> respuestas = (List<Respuesta>) repository.findRespuestaByAlumnosByExamen(alumnoId, examenId);
		return respuestas;
	}
	@Override
	public Iterable<Long> findExamenesIdsConRespuestasByAlumno(Long alumnoId) {
		...
		List<Long> examenIds = respuestasAlumno
				...
				.distinct().collect(Collectors.toList()); //  distinct Agrupa los valores repetidos en uno solo
		return examenIds;
	}
	@Override
